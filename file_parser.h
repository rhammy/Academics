...
//	tokenized_line blank_line = tokenized_line();
	//create vector
	std::vector<tokenized_line> tokenized_list;
//      	std::vector<tokenized_line> tokenized_list(1000, blank_line);
//	tokenized_list = new vector<tokenized_line>;
//	tokenized_list.reserve(1000);
